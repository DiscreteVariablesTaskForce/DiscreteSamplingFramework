...
class RandomWalk(ContinuousSampler):
    def __init__(self, model, data_function, **kwargs):
        self.stan_model = model
        self.data_function = data_function

    def sample(self, current_continuous, current_discrete, rng=RNG()):
        ...
        proposed_continuous[0:param_length] = current_continuous[0:param_length] + rng.randomMvNormal(mu, sigma)
