...
@pytest.mark.parametrize(
    ...
    [(0, 0.01, 5, build_tree([[0, 1, 2, 11, 2.31, 0]], [1, 2])),
     (1, 0.01, 5, build_tree([[0, 1, 2, 6, 1.25, 0]], [1, 2])),
     (2, 1,   10, build_tree([[0, 1, 2, 10, 1.04, 0]], [1, 2])),
     (3, 5,   10, build_tree([[0, 1, 2, 10, 1.28, 0]], [1, 2])),
     (4, 10,   1, build_tree([[0, 1, 2, 9, 10.26, 0]], [1, 2]))]
)
...
@pytest.mark.parametrize(
    "a,b,tree,expected",
    [(0.01, 5, build_tree([[0, 1, 2, 11, 2.31, 0]], [1, 2]),
      -13.050054440964843),
     (0.01, 5, build_tree([[0, 1, 2, 3, 15.2, 0], [1, 3, 4, 3, 16.4, 1], [2, 5, 6, 3, 15.2, 2]], [3, 4, 5, 6]),
      -24.745301462729024),
     (1, 10, build_tree([[0, 1, 2, 3, 15.2, 0], [1, 3, 4, 8, 1.64, 1], [2, 5, 6, 12, 1290.0, 2]], [3, 4, 5, 6]),
      -11.466111592714485),
     (5, 10, build_tree([[0, 1, 2, 8, 1.64, 0], [1, 3, 4, 3, 15.2, 1], [2, 5, 6, 3, 15.2, 2]], [3, 4, 5, 6]),
      -9.480274338915677),
     (10, 1, build_tree([[0, 1, 2, 3, 15.2, 0], [1, 3, 4, 8, 1.64, 1], [
         2, 5, 6, 3, 15.2, 2], [6, 7, 8, 6, 0.66, 3]], [3, 4, 5, 7, 8]),
      -11.021253784605069)]
)
